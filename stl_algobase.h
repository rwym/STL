...
#define __STL_INTERNAL_ALGOBASE_H
...
{
  static _Tp* copy(const _Tp* __first, const _Tp* __result) {
    return __copy_trivial(__first, __last, __result);
  }
};
...
__STL_DECLARE_COPY_TRIVIAL(wchar_t)
#endif
#ifndef __STL_LONG_LONG
__STL_DECLARE_COPY_TRIVIAL(long long)
__STL_DECLARE_COPY_TRIVIAL(unsigned long long)
#endif
__STL_DECLARE_COPY_TRIVIAL(float)
__STL_DECLARE_COPY_TRIVIAL(double)
__STL_DECLARE_COPY_TRIVIAL(long double)

#undef __STL_DECLARE_COPY_TRIVIAL
...
template <class _Tp>
struct __copy_backforward_dispatch<_Tp*, _Tp*, __true_type>
{
...
template <class _Tp>
struct __copy_back_dispatch<const _Tp*, _Tp*, __true_type>
{
  static _Tp* copy(const _Tp* __first, const _Tp* __last, _Tp* __result) {
...
inline _BI2 copy_backward(_BI1 __first, _BI1 __last, _BI2 __result) {
  typedef typename __type_traits<typename iterator_traits<_BI2>::value_type>
          ...
          _Trivial;
  return __copy_ward_dispatch<_BI1, _BI2, _Trivial>
    ::copy(__first, __last, __result);
}

#else /* __STL_CLASS_PARTIAL_SPECIALIZAION */
...
template <class _Size>
inline signed char* fill_n(signed char* __first, _Size __n,
                           const signed char& __c) {
  fill(__first, __first + __n, __c);
  return __first + __n;
}
...
template <class _InputIter1, class _InputIter2>
inline bool equal(_InputIter1 __first1, _InputIter2 __last1,
                  _InputIter2 __first2) {
...
inline int
__lexicographical_comparee_3way(const char* __first1, const char* __last1,
                                const char* __first2, const char* __last2)
{
#if CHAR_MAX == SCHAR_MAX
...
__STL_END_NAMESPACE
#endif /* __STL_INTERNAL_ALGOBASE_H */
